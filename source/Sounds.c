...
void axFrameCallback()
{
	...
	if (soundSel == STRTBKGND)
	{
		...
		voiceOffsets.endOffset = (971896 - 1);					// loop end at end of data (array size minus 1 see sound data header file).
		...
		voiceOffsets.data = (unsigned char*)DanceSlowMoWave;	// pointer to the actual sound data.
